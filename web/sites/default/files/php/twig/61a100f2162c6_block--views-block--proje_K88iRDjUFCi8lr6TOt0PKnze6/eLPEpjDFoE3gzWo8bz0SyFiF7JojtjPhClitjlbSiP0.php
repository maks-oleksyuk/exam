...
/* themes/custom/exam/templates/block/block--views-block--projects-view-block-1.html.twig */
class __TwigTemplate_9bac35684921102a70a8f2e5eeb5274097062d37d5e56f976a929c8503c6cd63 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["plugin_id"] ?? null), 4, $this->source)))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 9
            echo "    <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "container"], "method", false, false, true, 9), 9, $this->source), "html", null, true);
            echo "><span>";
...
";
  ...
  ";
    ...
    {
        return "themes/custom/exam/templates/block/block--views-block--projects-view-block-1.html.twig";
    }
...
<div{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}
    <h2{{ title_attributes.addClass('container') }}><span>{{ label }}</span></h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/exam/templates/block/block--views-block--projects-view-block-1.html.twig", "/var/www/web/themes/custom/exam/templates/block/block--views-block--projects-view-block-1.html.twig");
    }
